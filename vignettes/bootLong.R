...
## ----plot-sam-sch, fig.cap = "Sampling schedule"---------------------------
...
## ----pacf, fig.cap = "Partial autocorrelation within subject"--------------
...
## ----lag-plots, fig.cap = "Lag-plot for ASV_30"----------------------------
